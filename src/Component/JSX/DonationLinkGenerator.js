...
function PaymentLinkGenerator() {
  ...
  async function createPaymentLink() {
    ...
    await fetch(`https://alpha-payment-backend.vercel.app/api/generate-donation-link/${authToken}`, {
      method: "POST",
      headers: {
  ...
  useEffect(() => {
    ...
    fetch(`https://alpha-payment-backend.vercel.app/api/v1/getdonationid/${authToken}`)
    .then((response) => {
