...
function PaymentLinkGenerator() {
  ...
  async function createPaymentLink() {
    ...
    await fetch(`https://fyp.mahadevonlinebookid.com/api/generate-payment-link/${authToken}`, {
      method: "POST",
      headers: {
  ...
  useEffect(() => {
    ...
    fetch(`https://fyp.mahadevonlinebookid.com/api/v1/getpaymentid/${authToken}`)
    .then((response) => {
